          ...
          // j[1] is the data JSON object
        	...
        	// Main car's localization Data
          	...
          	//vector<double> next_y_vals;
						...
						for(int i = 0; i < 50; i++)
						{
							double radian_yaw = deg2rad(car_yaw);
              ...
              next_x_vals.push_back(xy[0]);
							...
							//next_x_vals.push_back(car_x+(dist_inc*i)*radian_yaw);
							//next_y_vals.push_back(car_y+(dist_inc*i)*radian_yaw);
						}
						*/
						// ######################################################## block 1
						...
						{
							// redefine reference state at previous paths end-point and starting reference
